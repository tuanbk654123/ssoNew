...
const ApiScopes = (props: Props) => {
  return (
    <div className="list">
      <Sidebar openKey={'sub2'}  isActiveHoverUser={false} isActiveHoverRole={false} isActiveHoverHistory={false} isActiveHoverClient={false} isActiveHoverApiScopes={true} isActiveHoverApiResources={false}
